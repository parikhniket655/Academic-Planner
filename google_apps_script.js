...
function mapToCourseCode(cName) {
  ...
  if (u.includes("GROWTH") || u.includes("E-COMMERCE") || u.includes("EMERGING") || u.includes("GSEC")) return "GSEC";
  if (u.includes("CYBER") || u.includes("CSY")) return "CSY";
  if (u.includes("AGENTIC") || u.includes("AI FOR BUSINESS") || u.includes("ADVANCED ACCOUNTING") || u.includes("AAB")) return "AAB";
  if (u.includes("INTERNATIONAL TRADE") || u.includes("INFORMATION TECH") || u.includes("IT STRATEGY") || u === "IT" || u.startsWith("IT ") || u.startsWith("IT(") || u.startsWith("IT1") || u.startsWith("IT2")) return "IT";
  if (u.includes("FIXED INCOME") || u.includes("SECURITIES") || u.includes("INSTITUTIONS") || u.includes("FINANCIAL SERVICES") || u.includes("FIS")) return "FIS";
  if (u.includes("FUTURES") || u.includes("OPTIONS") || u.includes("FINANCIAL RISK") || u.includes("OPERATIONS MANAGEMENT") || u.includes("FORM")) return "FORM";
  if (u.includes("MONEY") || u.includes("BANKING") || u.includes("MBFM")) return "MBFM";
  if (u.includes("INVESTMENT BANKING") || u.includes("INTERNATIONAL BUSINESS") || u === "IB" || u.startsWith("IB ") || u.startsWith("IB(") || u.startsWith("IB1") || u.startsWith("IB2")) return "IB";
  ...
  if (u.includes("NEGOTIATION") || u.includes("CONFLICT MANAGEMENT") || u.includes("COMMERCIAL MANAGEMENT") || u.includes("SNCM")) return "SNCM" + secStr;
  if (u.includes("STORYTELLING") || u.includes("SERVICES MARKETING") || u.includes("SSM")) return "SSM";
  if (u.includes("MARKSTRAT") || u.includes("MANAGEMENT SYSTEMS") || u.includes("MANAGEMENT STRUCTURE") || u.includes("MSS")) return "MSS" + secStr;
  if (u.includes("INTEGRATED MARKETING") || u.includes("COMMUNICATION") || u.includes("IMC")) return "IMC";
  if (u.includes("PRODUCT & BRAND") || u.includes("BRAND MANAGEMENT") || u.includes("PBM")) return "PBM" + secStr;
  if (u.includes("SERVICE MARKETING") || u.includes("STRATEGIC MANAGEMENT") || u === "SM" || u.startsWith("SM ") || u.startsWith("SM(") || u.startsWith("SM1") || u.startsWith("SM2")) return "SM";
  if (u.includes("MERGERS") || u === "M&A" || u.includes("M & A")) return "M&A";
  if (u.includes("ENTREPRENEURSHIP") || u === "ENV") return "ENV";
  if (u.includes("ENTERTAINMENT") || u.includes("SPORTS") || u.includes("EXECUTIVE SALES") || u === "ESMM" || u.startsWith("ESMM ") || u.startsWith("ESMM(")) return "ESMM";
  if (u.includes("SOCIAL MARKETING") || u.includes("SERVICE OPERATIONS") || u.includes("SOM")) return "SoM";
  if (u.includes("STRATEGIES FOR NEW AGE") || u.includes("NEW AGE BUSINESSES") || u.includes("SOCIAL NETWORK") || u.includes("SNAB")) return "SNAB";
  if (u.includes("NEW PRODUCT") || u.includes("NPD")) return "NPD";
  if (u.includes("MANUFACTURING SYSTEM") || u.includes("MARKET STRUCTURE") || u.includes("MSD")) return "MSD";
